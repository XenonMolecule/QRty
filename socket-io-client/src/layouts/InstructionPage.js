...
export default function InstructionPage() {
    ...
    return (
        <Container style={{'font-family':'Oswald'}}>
            ...
            <Row className="justify-content-center">
                <ul>
                <li>When you click the Start a Room button you will have created a private room to store your text and images.</li>
                ...
                <li>You can scan this QR code on mobile devices and then see your text and images across platforms</li>
